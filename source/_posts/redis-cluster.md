...
![img](redis-cluster/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzE2Mzk5OTkx,size_16,color_FFFFFF,t_70.png)
...
![img](redis-cluster/1478675-20190530111414956-1304307578.png)
...
Redis自动维护集群配置文件，不要手动修改，防止节点重启时产生集群信息错乱。
 ...
 ![image-20211127143430284](redis-cluster/image-20211127143430284.png)
...
![image-20211127204524760](redis-cluster/image-20211127204524760.png)
...
![img](redis-cluster/20210205165842362.png)
...
![image-20211128131539486](redis-cluster/image-20211128131539486.png)
...
![image-20211128134512270](redis-cluster/image-20211128134512270.png)
...
![image-20211128184145276](redis-cluster/image-20211128184145276.png)

执行指令`CLUSTER ADDSLOTS 1 2`之后变成：

![image-20211128184438831](redis-cluster/image-20211128184438831.png)
...
![img](redis-cluster/1478675-20190530112923984-1840717246.png)
...
![image-20211128221010442](redis-cluster/image-20211128221010442.png)
...
![image-20211129170705088](redis-cluster/image-20211129170705088.png)
...
![image-20211129180546751](redis-cluster/image-20211129180546751.png)
...
![image-20211129185032653](redis-cluster/image-20211129185032653.png)

![image-20211129190657841](redis-cluster/image-20211129190657841.png)

### 4.2故障检测

集群中每个节点会定期向其他节点发送PING消息，如果规定时间内没有返回PONG消息，则会将该节点标记为P_FAIL(疑似下线 probable fail)；

![image-20211129190723670](redis-cluster/image-20211129190723670.png)
...
![image-20211129194942175](redis-cluster/image-20211129194942175.png)
...
![image-20211129214514368](redis-cluster/image-20211129214514368.png)
